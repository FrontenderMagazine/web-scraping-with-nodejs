...
теме, [прочтите это][1], прежде чем продолжить. Кроме того,
...
Когда мы получим данные, будет вызван колбек, в который в качестве
аргументов будут переданы три переменные: `error`, `response` и `body`. 
Если Request не сможет скачать страничку и получить данные, он передаст 
...
синтаксис jQuery. Чтобы найти нужные нам данные на странице, 
