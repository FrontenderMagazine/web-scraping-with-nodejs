...
Что бы установить вышеупомянутые модули в Node.js используется [NPM][3],
...
который хотим скачать и функцию обратного вызова, в которой обработаем результаты 
запроса. Когда мы получим данные, будет вызвана функция обратного вызова, 
в которую будут переданы в качестве
